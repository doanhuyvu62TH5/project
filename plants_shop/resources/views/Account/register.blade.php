                        ...
                        <div class="col-md-6  d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form method="POST" action="{{ route('account.check_register') }}">
                                    ...
                                    <h2 class="mb-3 pb-3 text-center" style="letter-spacing: 1px;">Đăng ký tài
                                        khoản</h2>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="address" id="form2Example1"
                                            class="form-control form-control-lg" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="form2Example1">Số điện thoại</label>
                                        <input type="text" name="phone" id="form2Example1"
                                            class="form-control form-control-lg" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="confirm_password" id="form2Example2"
                                            class="form-control form-control-lg" />
                                    </div>
                                    ...
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Bạn đã có tài khoản?
                                        <a href="{{ route('account.login') }}" style="color: #393f81;">Đăng nhập ngay.</a>
                                    </p>
                                </form>
                            </div>
                        </div>
